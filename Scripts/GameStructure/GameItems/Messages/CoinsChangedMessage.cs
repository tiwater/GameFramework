...
namespace GameFramework.GameStructure.GameItems.Messages
{
    ...
    /// </summary>
    public class CoinsChangedMessage : BaseMessage
    {
        public readonly GameItem GameItem;
        public readonly int NewCoins;
        public readonly int OldCoins;

        public CoinsChangedMessage(GameItem gameItem, int newCoins, int oldCoins)
        {
            GameItem = gameItem;
            NewCoins = newCoins;
            OldCoins = oldCoins;
        ...
        {
            return string.Format("GameItem Type {0}, GameItem Number {1}, New Coins {2}, Old Coins {3}", GameItem.IdentifierBase, GameItem.GiId, NewCoins, OldCoins);
        }
    }
}
